  ...
  return (
    <div className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 hover:border-[#17A2B8] transition-colors group">
      <div className="flex justify-between items-start mb-3">
        <div>
          <span className="text-xs font-bold text-[#17A2B8] bg-[#E0F7FA] px-2 py-1 rounded-md">
            {order.id}
          </span>
          <h3 className="font-bold text-gray-800 mt-2 text-lg">
            {order.customerId}
          </h3>
      ...
      <div className="flex gap-4 text-sm text-gray-600 border-t border-gray-50 pt-3">
        <div className="flex items-center gap-1">
          <FileText size={16} className="text-gray-400" /> {order.totalAmount}{" "}
          Items
        </div>
        <div className="flex items-center gap-1">
