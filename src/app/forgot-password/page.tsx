            ...
            <div className="grow">
                ...
                <div className="bg-linear-to-r from-[#1dacbc] to-[#14939e] text-white py-10 md:py-12">
                    <div className="container mx-auto px-4">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold">Reset Password</h1>
                        <p className="text-[#e8faf7] text-base md:text-lg mt-2">We'll send you a link to reset your password</p>
                    </div>
                </div>
