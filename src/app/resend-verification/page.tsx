                            ...
                            {!submitted ? (
                                <>
                                    <p className="text-gray-600 mb-6">
                                        Enter the email address associated with your account. We'll send you a new verification link to complete your registration.
                                    </p>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        ...
                                        <div>
                                            ...
                                            />
                                            <p className="text-xs text-gray-500 mt-1">Verification link expires in 1 hour</p>
                                        </div>
                                    ...
                                    <div className="mt-6 text-center">
                                        <p className="text-gray-600">
                                            Already verified? <Link href="/signin" className="text-[#1dacbc] font-semibold hover:underline">Sign In</Link>
                                        </p>
                                    </div>
                                </>
                            ) : (
                                <>
                                    ...
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-gray-500 mb-6">
                                            Check your inbox and click the link to verify your email. The link will expire in 1 hour.
                                        </p>

                                        {/* Info Box */}
                                        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 text-left">
                                            <p className="text-sm text-yellow-700">
                                                <strong>Didn't receive the email?</strong> Check your spam folder or wait a few moments for it to arrive.
                                            </p>
                                        </div>
                                        ...
                                        <div className="border-t border-gray-200 pt-4 mt-4">
                                            <Link href="/" className="text-[#1dacbc] font-semibold hover:underline">
                                                Back to Home
                                            </Link>
                                        </div>
                                    </div>
