...
export default function AboutUsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#f9f9f9]">
            ...
            <div className="container mx-auto px-4 py-10 md:py-16">
                <div className="max-w-4xl mx-auto">
                    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-12">
                        <h1 className="text-3xl sm:text-4xl md:text-5xl text-center font-extrabold text-[#1dacbc] tracking-tight mb-6 md:mb-8">
                            OUR STORY
                        </h1>
            ...
            {/* Stats Section */}
            <div className="bg-[#1dacbc] text-white py-12 md:py-16">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
                        {stats.map((stat, index) => (
                            <div key={index} className="text-center">
                                <h3 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-1 md:mb-2">
                                    {stat.number}
                                </h3>
                                <p className="text-sm sm:text-lg md:text-xl font-medium opacity-90">
                                    {stat.label}
                                </p>
                            </div>
                        ))}
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {values.map((value, index) => (
                            <div
                                key={index}
                                className="bg-white rounded-2xl shadow-lg p-6 md:p-8 text-center hover:shadow-xl transition-shadow duration-300"
                            >
            ...
            {/* CTA Section */}
            <div className="bg-linear-to-r from-[#1dacbc] to-[#14939e] text-white py-12 md:py-16">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="bg-white text-[#1dacbc] w-full sm:w-auto px-8 py-3.5 rounded-full font-bold text-base md:text-lg hover:bg-gray-100 transition shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                    >
